...
$string['submissionstatement2']='okkk';


// For Downloading Images
$string['downloadimages']  = 'Download all submitted images';
$string['nothingtodo']      = 'No image submissions were found.';
$string['zipunavailable']   = 'Could not create ZIP archive. Please contact the administrator.';
$string['invaliduserid']    = 'Invalid student ID.';