...
// only show the export button to users who can view grades
if (has_capability('mod/assign:viewgrades', $context)) {
    $exporturl = new moodle_url('/mod/assign/export_images.php', ['id' => $cm->id]);
    $button    = html_writer::link(
        $exporturl,
        get_string('downloadimages', 'assign'),
