...
/**
 * attendanceregister_tracked_users_print.class.php - Class containing Attendance Register's tracked Users and their summaries
 *
 * @package    mod
 ...
 * @author nicus
 */
class attendanceregister_tracked_users_print {
