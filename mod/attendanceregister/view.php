...
if(isset($_POST['addsession']) && $_POST['addsession']==1)
{
   ...
   //echo "INSERT INTO {attendanceregister_session} (`id`, `register`, `login`, `logout`, `duration`, `userid`, `onlinesess`, `refcourse`, `comments`, `addedbyuserid`) VALUES (NULL, '".$_POST['registerid']."', '".strtotime($_POST['login'])."', '".strtotime($_POST['logout'])."', '".$duration."', '".$_POST['userid']."', '1', NULL, '".$_POST['comments']."', NULL)"; die;
...
echo '&nbsp;&nbsp;<input class="button button4" type="submit" name="search" id="search" value=" Search "  />';
echo '&nbsp;&nbsp;<input class="button button4" type="submit" name="showall" id="showall" value=" Show All " onclick=\'javascript: document.getElementById("to_date").value=""; document.getElementById("from_date").value="";\' />';
...
echo '<br/><div align="left"><input class="button button4" type="button" name="download" id="download" value= " Printable Version " onclick=\'javascript: printPage();\' /></div></br>';
...
//    echo '</div>';    
	...
	if (isset($allreaders['logstore_standard'])) {
       ...
       //  echo '<div align="left"><input type="button" name="download" id="download" value= " Printable Version " onclick=\'javascript: downloadFile();\' /></div>';
