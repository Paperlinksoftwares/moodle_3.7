...
if($u1==true)
{
    $urltogo= $CFG->wwwroot.'/mod/attendance/take2.php?id='.$_GET['id'].'&update=1&sessionid='.$_GET['sessionid'].'&grouptype='.$_GET['grouptype'];
    ?>
...
{
    $urltogo= $CFG->wwwroot.'/mod/attendance/take2.php?id='.$_GET['id'].'&update=0&sessionid='.$_GET['sessionid'].'&grouptype='.$_GET['grouptype'];
    ?>
<div style="padding-left: 412px; padding-top: 181px;"><img src='<?php echo $CFG->wwwroot; ?>/mod/attendance/pix/loader.gif' border='0'></div>
<script> window.location.href='<?php echo $urltogo; ?>'; </script>
<?php
...
<label class="container"><input type="radio" name="full_'.$users->id.'" id="full_'.$users->id.'" value="1" onchange=\'javascript: setAllChecked('.$users->id.','.$duration_hours.','.$duration_show_fraction.');\'  /><span class="checkmark2"></span>
</label></td>';
