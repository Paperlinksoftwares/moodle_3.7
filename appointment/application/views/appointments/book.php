    ...
    <div id="main" class="container">
        <div class="wrapper row">
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                        ...
                        <div class="frame-content">
                            <div class="form-group">
							 <label for="select-service">
                                    <strong>Requested Units</strong>
									<?php echo $unit_requested_by_student->unit_request; ?>
                                </label>
                                <label for="select-service">
                        ...
                        <div class="frame-content row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="notes" maxlength="500" class="form-control" rows="3"><?php echo $unit_requested_by_student->unit_request; ?></textarea>
                                </div>
                            </div>
                ...
                <div id="frame-footer">
                    Powered By
                    <a href="http://accit.nsw.edu.au" target="_blank">ACCIT| Australia</a>
