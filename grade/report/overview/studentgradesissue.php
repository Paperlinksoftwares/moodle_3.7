...
'; echo $rowc;	?>' 
		style="outline: 1px solid black; height: 15px; width:15px; border: none;" type="checkbox" name="select_course[]" id="<?php echo $mm.$rowc;	?>" value="<?php echo $val[2]->id; ?>" />&nbsp;&nbsp;<a href="<?php echo $CFG->wwwroot; ?>/course/view.php?id=<?php echo $val[2]->id; ?>" target="_blank" <?php if($val[2]->category==97 || $val[2]->category==98 || $val[2]->category==104 || $val[2]->category==111 || $val[2]->category==112 || $val[2]->category==116 || $val[2]->category==144 || $val[2]->category==164 || $val[2]->category==165 || $val[2]->category==166 || $val[2]->category==168 || $val[2]->category==195 || $val[2]->category==194 || $val[2]->category==201) { ?> style="color: red!important; font-weight: bold!important;" <?php } ?> <?php if($val[2]->category==113 || $val[2]->category==115 || $val[2]->category==117 || $val[2]->category==128 || $val[2]->category==114 || $val[2]->category==137 || $val[2]->category==138) { ?> style="color: green!important; font-weight: bold!important;" <?php } ?> style="color: #000000; font-weight: bold!important;" ><?php echo $val[0]; ?></a>
 ...
 <table id="customers2">
  ...
  foreach($list_result_checklist as $key=>$val)
  {
	...
	$list_all_deb22 = $DB->get_record_sql($sql_checklist22);
	  ...
	  ?>
	   <tr>
      <td><a target="_blank" href="<?php echo $CFG->wwwroot; ?>/mod/<?php echo $val->itemmodule; ?>/view.php?id=<?php echo $list_all_deb22->checklistid; ?>"><?php echo $val->itemname; ?></a></td>
