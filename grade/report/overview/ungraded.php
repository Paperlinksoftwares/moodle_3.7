...
$stnew2 = "[".$st2."]"; 	
 ...
 <input id="studentid" type="hidden" name="studentid" value="" />
			...
			<form name="search2" autocomplete="off" action="ungraded.php?qualification_name=<?php echo $_GET['qualification_name']; ?>" method="POST">
			<table>
			<tr>
			<td>&nbsp;</td>
			<td></td>
...
?>
<script>
document.getElementById('countnew').innerHTML="Total Records Found : <?php echo $count_updated; ?>";
</script>
<div id="countnew"></div>
<br/>
         <table id="customers">
             ...
             // inp.value = this.getElementsByTagName("input")[0].value; 
				...
				else if(type==4)
                {
                   ...
                   // document.getElementById("qualification_id").value = this.getElementsByTagName("input")[0].value; 
					window.location.href='ungraded.php?qualification_name='+this.getElementsByTagName("input")[1].value; 
                }
                else
                {
                }
