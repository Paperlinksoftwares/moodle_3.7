<script>
var p = confirm("ACCIT has announced holidays from 24th 2019 til 3rd Jan 2020. Are you excited?");
if(p==true)
{
	window.location.href="https://www.cntraveler.com/restaurants/sydney/bennelong";
}
</script>
<?php
...
<div class="accordion_container">
    <?php $course_name = array(); foreach($data_all as $key=>$val) { $course_name[] = $val[0]; $startdate = $val[2]->startdate; ?>
        ...
        <div class="accordion_head"><input style="outline: 1px solid black; height: 15px; width:15px; border: none;" type="checkbox" name="select_course[]" id="select_course[]" value="<?php echo $val[2]->id; ?>" />&nbsp;&nbsp;<a href="<?php echo $CFG->wwwroot; ?>/course/view.php?id=<?php echo $val[2]->id; ?>" target="_blank" <?php if($val[2]->category==97 || $val[2]->category==98 || $val[2]->category==104 || $val[2]->category==111 || $val[2]->category==112 || $val[2]->category==116) { ?> style="color: red!important; font-weight: bold!important;" <?php } ?> <?php if($val[2]->category==113 || $val[2]->category==115 || $val[2]->category==117) { ?> style="color: green!important; font-weight: bold!important;" <?php } ?> style="color: #000000; font-weight: bold!important;" ><?php echo $val[0]; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #6aad1d; font-weight: bold;"><?php //echo $val[1]; ?></span><span class="plusminus">+</span></div>
...
<?php } else { echo '&nbsp;&nbsp;<span style="color: red!important; font-weight: bold!important;">The student did not view the assesments yet!</span>'; }
