...
$string['pluginname'] = 'Assesments / Grades Dates Management';
...
// The below block is used for exporting filtered excel data
// export page
// Accordion panel title
$string['exportoptions'] = 'Export Data';
$string['exportpagetitle'] = 'Timestamp Export';
$string['exportpage']      = 'Export to Excel';

// column headers
$string['studentname']     = 'Student';
$string['assignment']      = 'Assignment';
$string['submissiontime']  = 'Submission Time';
$string['gradetime']       = 'Grade Modified Date';
$string['gradername']      = 'Trainer';
$string['attempt']         = 'Attempt';

// error when no filters
$string['nofilters']       = 'Please apply at least one filter before exporting.';

// The below block is used for exporting excel data for all courses
$string['exportallpage'] = 'Export All to Excel';
