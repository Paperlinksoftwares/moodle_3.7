...
namespace tool_timestamp\output;                                                                                                         
...
class index_page implements renderable, templatable {                                                                               
    ...
    public function __construct($arr,$coursestr,$assessmentstr,$studentsstr,$studentsstrusername,$page,$total,$poststudentname,$postcoursename,$postassessmentname,$poststudentusername,$cid,$aid,$sid,$suid,$sortval,$sortvalold,$sorttype,$showallstudent) {                                                                                        
        $this->arr = $arr;                        
        $this->page = $page;  
