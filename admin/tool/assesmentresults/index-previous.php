...
if(isset($_POST['searchnew']) && $_POST['searchnew']==" Search ")
{
    
    if(isset($_POST['selectyear']) && $_POST['selectyear']>0)
    {
        
        $SESSION->selectyear = $_POST['selectyear']; 
        $yearclause = ' YEAR(FROM_UNIXTIME(course.startdate)) = "'.$_POST['selectyear'].'"';
		$SESSION->yearclause = $yearclause; 		
    }
	
	if(isset($_POST['selectterm']) && $_POST['selectterm']>0)
    {
        
        $SESSION->selectterm = $_POST['selectterm'];  
		if($_POST['selectterm']==1)
		{
			$termclause = '(MONTH(FROM_UNIXTIME(course.startdate)) = "1" OR MONTH(FROM_UNIXTIME(course.startdate)) = "2" OR MONTH(FROM_UNIXTIME(course.startdate)) = "3")';	
		}
        else if($_POST['selectterm']==2)
		{
			$termclause = '(MONTH(FROM_UNIXTIME(course.startdate)) = "4" OR MONTH(FROM_UNIXTIME(course.startdate)) = "5" OR MONTH(FROM_UNIXTIME(course.startdate)) = "6")';	
		}
		else if($_POST['selectterm']==3)
		{
			$termclause = '(MONTH(FROM_UNIXTIME(course.startdate)) = "7" OR MONTH(FROM_UNIXTIME(course.startdate)) = "8" OR MONTH(FROM_UNIXTIME(course.startdate)) = "9")';	
		}
		else
		{	
			$termclause = '(MONTH(FROM_UNIXTIME(course.startdate)) = "10" OR MONTH(FROM_UNIXTIME(course.startdate)) = "11" OR MONTH(FROM_UNIXTIME(course.startdate)) = "12")';	
		}	
		$SESSION->termclause = $termclause; 	
    }
...
else if(isset($_POST['searchnew']) || ($SESSION->termclause!='' && $SESSION->yearclause!=''))
{
...
//echo '<hr>';
//echo $sql;
if(@$SESSION->courseid!='' || @$SESSION->studentuserid!='' ||  @$SESSION->assessmentid!='' || @$SESSION->studentid!='' || isset($_POST['searchnew']) || ($SESSION->termclause!='' && $SESSION->yearclause!=''))
{
