...
$pagetitle = $title;
$url = new moodle_url("/admin/tool/assesmentresults/indexnew.php");
$PAGE->set_url($url);
...
//echo '<hr>';
//echo $sql;
if(@$SESSION->courseid!='' || @$SESSION->studentuserid!='' ||  @$SESSION->assessmentid!='' || @$SESSION->studentid!='' || isset($_POST['searchnew']))
{
