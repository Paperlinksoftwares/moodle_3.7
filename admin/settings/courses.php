...
$ADMIN->add("courses", new admin_externalpage('index', "Assignment Notifications", "$CFG->wwwroot/$CFG->admin/tool/timestamp/index.php?showall=1"));

//FOR RESULTS PART 

$ADMIN->add("courses", new admin_externalpage('index', "Assessments Results", "$CFG->wwwroot/$CFG->admin/tool/assesmentresults/index.php?reset=1"));

//FOR RESULTS BY COURSE / UNITS BY TERMS

$ADMIN->add("courses", new admin_externalpage('index', "Course Results", "$CFG->wwwroot/grade/report/overview/gradesbycourse.php"));


//For Plagiarism
$ADMIN->add("courses", new admin_externalpage('index', "Assessments Plagiarism", "$CFG->wwwroot/$CFG->admin/tool/assesmentplagiarism/index.php?reset=1"));



//for file submissions
//$ADMIN->add("courses", new admin_externalpage('index', "Submissions", "$CFG->wwwroot/$CFG->admin/tool/submissions/index.php?reset=1"));
