...
<?php
$sql_begin = "SELECT d.id , d.date , d.term, d.year , u.firstname, u.lastname , u.email, u.id as userid 
...
<?php if($total>0) { ?><a href="download.php?sql_param=<?php echo $sql_param; ?>" style="background-color: green;
  ...
  padding: 10px;
  text-decoration: none;
  text-transform: uppercase; height:20px; margin-left:15px;"><strong>DOWNLOAD EXCEL</strong></a><?php } ?>
</div><br/><br/>
<table width="100%" border="1" cellspacing="0" cellpadding="4">
  <tr>
    ...
    <td bgcolor="#CCCCCC"><strong>Date of Popup Alert</strong></td>
  </tr>
  <?php
