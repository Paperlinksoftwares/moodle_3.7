...
$current_term = 4;
$payment_due_list = array("1485", "1334", "a001342", "1489", "1998", "1465", "1331", "1548", "1467", "1519", "1552", 
"1502", "1523", "1472", "1551", "a001413", "1462", "a001048", "1379", "1499", "1479", "1388", "1357", "1389");
$exclude_students_payment = array();

foreach($payment_due_list as $mc=>$nc)
{
	$sql_exclude_payment = "SELECT `id`  FROM `mdl_user` WHERE `username` = '".$nc."'";
	$row_exclude_payment = $DB->get_record_sql($sql_exclude_payment);
	$exclude_students_payment[] = $row_exclude_payment->id;	
	unset($sql_exclude_payment);
	unset($row_exclude_payment);
}
if(in_array($USER->id,$exclude_students_payment)==true)
{
	header('Location: http://localhost/accit-moodle/accit/accountrestriction/');
	exit();
}
